...
/*
#cgo windows CFLAGS: -IC:/OpenSSL-Win64/include
#cgo windows LDFLAGS: -LC:/OpenSSL-Win64/lib/VC/x64/MD -lssl -lcrypto -lws2_32 -lcrypt32
...
static char* smime_decrypt(const char* input_file, const char* key_file, const char* output_file) {
...
func SslDecrypt(name, filename, keyFixPath string) (out string, errOut error) {
	...
	// Convert the output bytes to a string (decrypted content)
